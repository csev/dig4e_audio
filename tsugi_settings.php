...
// Theme like the Dig4E Audio site
$CFG->theme = array(
    "primary" => "#0D805B", // nav background, splash background, buttons, text of tool menu
...
$CFG->context_title = "Digitization for Everybody (Dig4E) - Audio";
