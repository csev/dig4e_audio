...
/**
 * Installation sanity checks for the Dig4E Audio home page only.
 *
...
function dig4e_audio_sanity_die($title, $body_html) {
    error_log('Dig4E Audio sanity: '.$title);
...
$tsugi_url = 'tsugi/';
$repo_dir = 'dig4e_audio';

if ( ! is_dir($tsugi_dir) ) {
    dig4e_audio_sanity_die(
        'Tsugi is not installed',
        '<p>This copy of Digitization for Everybody — Audio expects a <code>tsugi</code> folder next to
...
composer install</pre>
        ...
        <p>More detail: <a href="https://github.com/csev/dig4e_audio"
        target="_blank" rel="noopener noreferrer">Dig4E Audio on GitHub</a> and
...
$CFG->apphome = \'https://audio.dig4e.com\';

# Local example (adjust host, port, and path):
$wwwroot      = \'http://localhost/dig4e_audio/tsugi\';
$CFG->apphome = \'http://localhost/dig4e_audio\';</pre>
