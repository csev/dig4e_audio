...
- Lesson styling: `css/lessons.css` (audio-specific Tsugi class names)
...
- Brand accent color: `#0D805B`
- Match patterns used in the imaging and video siblings where the sites are intentionally parallel
